    ...
    <footer className="bg-slate-900 text-slate-300 py-12 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center mb-4 text-white">
              <Droplet size={24} className="text-brand-500 mr-2" fill="currentColor" />
              <span className="text-2xl font-bold">RO<span className="text-brand-500">Guard</span></span>
            </div>
            <p className="text-sm text-slate-400">
              Trusted providers of advanced water purification systems and reliable maintenance services since 2015.
            </p>
          </div>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500">
          <p>&copy; {new Date().getFullYear()} ROGuard Systems. All rights reserved.</p>
